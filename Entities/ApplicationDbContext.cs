        ...
        public void Populate()
        {
            try
            {
                ...
                if (!lernens.Any())
                {
                    ...
                    {
                        idLernen = 41,
                        nameLernen = "41. Кожа. Строение и функции кожи. Механизмы терморегуляции. Тепловой и солнечный удар. Гигиена кожи. Ожоги и обморожения. ",
                        coursesItemId = 1
                    },
                    new LernenItem
                    {
                    ...
                    {
                        idLernen = 43,
                        nameLernen = "43. Половая система. Строение мужской и женской половых систем. Методы контрацепции. Развитие организма человека. Роды. Гигиена половой системы.",
                        coursesItemId = 1
                    },
                    new LernenItem
                    {
                        idLernen = 44,
                        nameLernen = "44. Общая биология – наука об общих закономерностях живого. Жизнь как особая форма движения материи и признаки живого. Уровни организации живых систем. Клетка – структурная и функциональная единица жизни. Цитология как наука. Методы изучения клетки. Клеточная теория. Содержание химических элементов в клетке, их функции. Вода и минеральные соли, их роль в клетке. Органические вещества клетки. Белки, липиды, углеводы, их роль в клетке. Ферменты, строение и механизм действия. Нуклеиновые кислоты, их строение и функции. Значение АТФ в клетке.",
                        coursesItemId = 1
                    },
                    new LernenItem
                    {
